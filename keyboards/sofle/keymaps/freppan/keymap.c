    ...
    [0] = LAYOUT_SPLIT_WRAPPER(
        ...
        // Left half
         ...
         KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,
                           KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, MO(1),
...
KC_BSPC, KC_ENT,  KC_DEL,  KC_RALT, KC_RBRC
    ...
    [1] = LAYOUT_SPLIT_WRAPPER(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,
        KC_RALT, KC_MPRV, KC_MNXT, KC_MPLY, KC_VOLD, KC_VOLU,
        KC_LSFT, KC_NUBS, KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,
...
KC_NO, KC_NO,   KC_NO,   KC_LCBR, KC_RCBR, KC_COMM, KC_DOT,
